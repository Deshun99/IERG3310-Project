...
addr = (localhost, iUDPPortStudent)
...
####################### Receiving the super long message from robot #############
...
# s3.sendto(str(decodedStuff).encode(),(studentIP,iUDPPortRobot))
# print("\nSending back the encoded stuff")
